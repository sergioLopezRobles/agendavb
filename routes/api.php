...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/notificaciones', [TicketController::class, 'obtenerNotificaciones']);
    Route::post('/notificaciones/leer', [TicketController::class, 'marcarNotificacionesLeidas']);
});

// 3. ZONA DUEÑOS (Exclusivo Rol 2)
...
// 4. ZONA ADMINISTRADOR (Exclusivo Rol 1)
